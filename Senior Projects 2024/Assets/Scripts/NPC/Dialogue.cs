...
/*
 * todo:
 * have LLM conversation begin with something generated for the player to respond to
 * 
 */
...
public class Dialogue : MonoBehaviour
{
    ...
    //Continue the conversation for three player inputs then say goodbye - Lanielle
    public void onInputFieldSubmit(string message)
    {
        playerText.interactable = false;
        if (count > 2)
